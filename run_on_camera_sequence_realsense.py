"""
Use example:
python run_on_camera_sequence_realsense.py --use_region -b obj_000014 -m /home/mfourmy/Documents/ciirc_research/data/local_data_happypose/urdfs/ycbv/obj_000014
...
def parse_script_input():
    ...
    parser.add_argument('-s', '--scale_geometry', dest='scale_geometry', default=0.001, type=float, required=False, help='Scale factor to convert model geometry to meters.')
